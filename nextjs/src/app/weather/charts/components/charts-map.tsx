...
/**
 * The map: click anywhere to move the pin, or drag the pin itself. Both
 * charts below it are read for wherever it ends up.
 *
 * This is the picker the other examples use, drawn here rather than taken
 * from the component library: the map on the Maps page is the package's own
 * and comes with its layers and its control panel, which is more than a
 * location needs.
 *
...
export default function ChartsMap({ picked, onPick }: ChartsMapProps) {
